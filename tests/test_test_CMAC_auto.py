"""自动生成测试 - backend/.venv/Lib/site-packages/Cryptodome/SelfTest/Hash/test_CMAC.py"""
# AUTO-GENERATED
import pytest
import sys
...
try:
    from backend..venv.Lib.site-packages.Cryptodome.SelfTest.Hash.test_CMAC import *  # noqa
    _OK = True
