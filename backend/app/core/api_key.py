...
def hash_api_key(raw: str, secret_salt: str) -> str:
    ...
    Note: SHA-256 is acceptable here because API keys have sufficient entropy
    (token_urlsafe(32) = 256 bits). Unlike passwords, API keys don't need
    slow hashing (bcrypt/scrypt) as brute-force is infeasible with high entropy.
    The secret_salt provides additional protection against rainbow table attacks.
    """
