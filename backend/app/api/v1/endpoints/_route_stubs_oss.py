...
async def _stub(path: str, method: str, note: str = ""):
    raise HTTPException(status_code=501, detail=f"Endpoint not implemented: {method} {path} {note}")  # i18n
...
async def stub_post_login_admin_access_token():
    ...
    raise HTTPException(status_code=501, detail="Enterprise-only endpoint, not implemented in open-source edition")  # i18n
