...
from app.core.media_nodes_db import (
    get_all_media_from_nodes as get_all_media_from_db_nodes,
    get_cluster_status,
    list_db_media_nodes,
)
...
# FIX [2026-07-19]: 集群状态查询端点（Task 6: 集群监控接口）。
# 提供 total/online/offline 节点数、单节点健康状态、聚合流计数，
# 供仪表盘和集群监控使用。
