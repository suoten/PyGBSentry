...
def _get_totp_cipher():
    ...
    # FIXED: removed fallback hardcoded key - SECRET_KEY must be set
...
def decrypt_totp_secret(ciphertext: str) -> str:
    ...
    try:
        ...
        logger.warning("TOTP secret decryption failed - SECRET_KEY may have changed. User must re-enroll TOTP.") # FIXED: 解密失败时记录警告而非静默返回密文
        return ""
