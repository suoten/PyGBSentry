...
_CLUSTER_CHANNELS = {
    ...
    "subscribe_notify": "gb:cluster:subscribe_notify",  # FIXED: 订阅通知跨节点同步
    "alarm_notify": "gb:cluster:alarm_notify",  # FIXED: 报警通知跨节点同步
    "ssrc_allocate": "gb:cluster:ssrc_allocate",  # FIXED: SSRC分配跨节点协调
}
