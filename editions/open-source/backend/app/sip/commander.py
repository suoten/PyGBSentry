...
class SipCommander:
    ...
    async def send_catalog_query(self, device_id: str, transport_info: tuple, wait_response: bool = False):
        ...
        # Build XML Body
        sn = _next_sn()  # FIXED: SN序列号使用递增计数器替代随机数
...
"""
        ...
        if wait_response:
            ...
            _sip_trace_log(
                ...
                rtt_ms=int(meta.get("rtt_ms") or 0),
