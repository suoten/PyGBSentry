<template>
  <div class="app-page space-y-4" v-loading="loading">
    <PageContainer>
      <template #header>
        <PageHeader title="手机版" description="版本发布、下载入口与运行日志概览" />
      </template>
      <TableCard>
        ...
        <div class="flex flex-wrap gap-2">
          <el-button v-if="version.android_url" type="primary" @click="openUrl(version.android_url)">安卓下载</el-button>
          <el-button v-if="version.ios_url" @click="openUrl(version.ios_url)">iOS 下载</el-button>
